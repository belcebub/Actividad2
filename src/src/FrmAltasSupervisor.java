 ...
 * @author beelze
 */
public class FrmAltasSupervisor extends javax.swing.JDialog {

    int clave;
    /**
     * Creates new form FrmAltasSupervisor
     */
    public FrmAltasSupervisor(java.awt.Frame parent, boolean modal, int clave) {
        super(parent, modal);
        this.clave = clave;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("ALTA DE UN SUPERVISOR");
    ...
    private void btnGrabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGrabarActionPerformed
        Empleado e = new Supervisor(txtArea.getText(), Float.parseFloat(txtBono.getText()), 
                clave, txtNombre.getText(), 
                Float.parseFloat(txtSalario.getText()));
        ae.altas(e);
        JOptionPane.showMessageDialog(
                this, 
                "El supervisor fue dado de alta con exito",
                "Alta exitosa", 
